...
# Repositories Anthias images have been published under. This fork
# pulls from docker.io/robkanthias (see the image-pipeline policy in
# tools/image_builder); the upstream names below linger only on devices
# installed before the fork, where they are dead weight by definition.
ANTHIAS_REPOS=(
    'robkanthias/anthias-*'
