...
def get_url_patterns() -> list[URLPattern | URLResolver]:
    return [
        ...
        path(
            'v2/playlists',
            PlaylistListViewV2.as_view(),
            name='playlist_list_v2',
        ),
        path(
            'v2/playlists/<str:playlist_id>',
            PlaylistViewV2.as_view(),
            name='playlist_detail_v2',
        ),
        path(
            'v2/playlists/<str:playlist_id>/items',
            PlaylistItemsViewV2.as_view(),
            name='playlist_items_v2',
        ),
        path(
            'v2/playlists/<str:playlist_id>/items/<int:item_id>',
            PlaylistItemViewV2.as_view(),
            name='playlist_item_v2',
        ),
        path(
            'v2/playlists/<str:playlist_id>/order',
            PlaylistItemsOrderViewV2.as_view(),
            name='playlist_items_order_v2',
        ),
        path(
